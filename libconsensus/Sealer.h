...
public:
    ...
    /// 1. the block has been sealed 什么情况下会发生？ zhuangql
...
protected:
    ...
    virtual bool checkTxsEnough(uint64_t maxTxsCanSeal)
    {
        ...
        bool enough =//canHandleBlockForNextL-eader()没看懂
...
protected:
    ...
    //创建sealer后创建consensus-engine，直接赋值给sealer 
    ...
    std::atomic<bool> m_syncTxPool = {false};//标记是否同步交易池，即load交易
